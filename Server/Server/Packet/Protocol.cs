...
namespace Google.Protobuf.Protocol {
  ...
  /// <summary>
  /// GameObject 클래스의 공용 타입.
  /// 여기 만드는게 클라에서도 바로 갖다쓸수 있고, 패킷화하기도 쉽다
  /// </summary>
  ...
  public sealed partial class S_EnterGame : pb::IMessage<S_EnterGame> {
    ...
    /// <summary>
    /// 플레이어 정보를 받기위한 용도라 이름까지 바꾸지는 않았다.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
  ...
  public sealed partial class S_Spawn : pb::IMessage<S_Spawn> {
    ...
    /// <summary>
    /// repeated는 list형태, 여러명이 스폰될수도 있으니까
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
  ...
  /// <summary>
  /// 우리가 필요한 구조체 자체를 proto 파일에서 만들어도 된다.
  /// 공용으로 사용하기 위해 중의적인 이름 사용
  /// </summary>
